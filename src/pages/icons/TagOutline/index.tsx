...
const TagOutline = (props: IconProps) => {
  return (
    <Icon {...props}>
      <path
        fillRule='evenodd'
      ...
      />
      <path d='M68 58C68 63.5228 63.5228 68 58 68C52.4772 68 48 63.5228 48 58C48 52.4772 52.4772 48 58 48C63.5228 48 68 52.4772 68 58Z' />
    </Icon>
  );
};
