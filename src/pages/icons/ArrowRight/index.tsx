  ...
  return (
    <Icon {...props}>
      <path
        fillRule='evenodd'
        clipRule='evenodd'
        d='M25 95.0005C25 91.6868 27.6863 89.0005 31 89.0005H152C155.314 89.0005 158 91.6868 158 95.0005C158 98.3142 155.314 101.001 152 101.001H31C27.6863 101.001 25 98.3142 25 95.0005Z'
      />
      <path
        fillRule='evenodd'
        clipRule='evenodd'
