...
1. Importe o css no componente raiz do projeto.
2. Configure o ThemeProvider no componente raiz.
3. Pronto.

```tsx
import '@eduzz/houston-ui/ThemeProvider/theme.css'; // <~importar css base (que tem o css do AntD)
