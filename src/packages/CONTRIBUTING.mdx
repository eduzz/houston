...
import ExampleImage from '../static/img/example.png';
...
- Lembre-se que o _Houston™️_ também será usado com o [`react-native`](https://reactnative.dev), menos o package [**ui-components**](https://github.com/eduzz/houston/tree/master/packages/ui-components).
...
temas dele criamos o **withHoustonTheme** que aplicará o tema do Houston™ apenas nos componentes do Houston™.
...
Ele irá buildar e iniciar o projeto de docs em **http://localhost:3000** e o de dev em **http://localhost:3001**.
...
<img src={ExampleImage} width='250' />
