...
var SWITCH_MEDIUM_HEIGHT = 20;
var SWITCH_SMALL_HEIGHT = 16;
export default function components(palette) {
    return {
        MuiButton: {
            styleOverrides: {
                root: {
            ...
            styleOverrides: {
                root: {
                    '&.input-size-small': {
                        ...
                        '& label': {
                            transform: "translate(" + defaultThemeVariables.spacing(4) + "px, " + (defaultThemeVariables.spacing(2) + 2) + "px) scale(1)"
                        }
                    }
                }
            }
