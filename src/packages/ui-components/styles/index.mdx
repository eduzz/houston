...
_a interface IUseStyleParam conforme o exemplo abaixo_

```tsx
import createUseStyle, { IUseStyleParam } from '@eduzz/houston-ui/styles/createUseStyles';
...
const useStyle = createUseStyle({
  ...
  content: ({ props, theme }: IUseStyleParam<IProps>) => {
    return {
