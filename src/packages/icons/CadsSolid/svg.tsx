...
export default ({ width = sizeMap.medium }) => (
  <svg width={width} viewBox='0 0 192 192' fill='none' xmlns='http://www.w3.org/2000/svg'>
    ...
    />
    <path
      d='M38.959 39.2083C38.959 35.7796 41.7385 33 45.1673 33H169.334C172.763 33 175.542 35.7796 175.542 39.2083V54.7292H38.959V39.2083Z'
      fill='#546E7A'
    />
    <path
      d='M38.959 74.1304H175.542V126.125C175.542 129.554 172.763 132.333 169.334 132.333H45.1673C41.7386 132.333 38.959 129.554 38.959 126.125V74.1304Z'
      fill='#546E7A'
    />
  </svg>
);
