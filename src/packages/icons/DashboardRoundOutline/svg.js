...
exports.default = ({ width = getIconSize_1.sizeMap.medium }) => (React.createElement("svg", { width: width, viewBox: '0 0 192 192', fill: '#546E7A', xmlns: 'http://www.w3.org/2000/svg' },
    React.createElement("path", { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M89.0001 33H89C51.4446 33 21 63.4446 21 101C21 138.555 51.4446 169 89 169C125.272 169 154.911 140.601 156.894 104.825H157.002V92.825H101V33H89.0001ZM89.0001 92.825V45H89C58.0721 45 33 70.0721 33 101C33 131.928 58.0721 157 89 157C118.642 157 142.906 133.969 144.871 104.825H88.9964V92.825H89.0001Z' }),
    React.createElement("path", { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M112.791 22.2552V33.8402V34.1731V72.325V84.325H124.791H159.269H159.756H171.159L171.329 84.1278C170.887 80.0816 170.106 76.1376 169.013 72.325C162.722 50.3749 146.124 32.7807 124.791 25.1149C121 23.7527 117.06 22.7039 113.001 22L112.791 22.2552ZM156.421 72.325C151.032 57.0238 139.5 44.605 124.791 38.0405V72.325H156.421Z' })));
