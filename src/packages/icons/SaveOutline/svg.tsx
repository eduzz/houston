...
export default ({ width = sizeMap.medium }) => (
  <svg width={width} viewBox='0 0 192 192' fill='none' xmlns='http://www.w3.org/2000/svg'>
    ...
    <path
      d='M62 36C62 32.6863 64.6863 30 68 30H123C126.314 30 129 32.6863 129 36V58C129 61.3137 126.314 64 123 64H68C64.6863 64 62 61.3137 62 58V36Z'
      fill='#546E7A'
    />
    <path
      d='M56 118C56 114.686 58.6863 112 62 112H130C133.314 112 136 114.686 136 118V154C136 157.314 133.314 160 130 160H62C58.6863 160 56 157.314 56 154V118Z'
      fill='#546E7A'
    />
  </svg>
);
