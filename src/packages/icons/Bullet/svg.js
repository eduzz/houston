...
exports.default = ({ width = getIconSize_1.sizeMap.medium }) => (React.createElement("svg", { width: width, viewBox: '0 0 192 192', fill: '#546E7A', xmlns: 'http://www.w3.org/2000/svg' },
    React.createElement("path", { d: 'M136 96C136 73.9086 118.091 56 96 56C73.9086 56 56 73.9086 56 96C56 118.091 73.9086 136 96 136C118.091 136 136 118.091 136 96Z' })));
