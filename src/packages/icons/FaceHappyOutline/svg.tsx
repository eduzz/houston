...
export default ({ width = sizeMap.medium }) => (
  <svg width={width} viewBox='0 0 192 192' fill='none' xmlns='http://www.w3.org/2000/svg'>
    <path
      d='M76 90C76 98.8366 68.8366 106 60 106C51.1634 106 44 98.8366 44 90C44 81.1634 51.1634 74 60 74C68.8366 74 76 81.1634 76 90Z'
      fill='#546E7A'
    />
    <path
      d='M148 90C148 98.8366 140.837 106 132 106C123.163 106 116 98.8366 116 90C116 81.1634 123.163 74 132 74C140.837 74 148 81.1634 148 90Z'
      fill='#546E7A'
    />
    <path d='M96 140C109.255 140 120 132.837 120 124H72C72 132.837 82.7452 140 96 140Z' fill='#546E7A' />
    <path
      fillRule='evenodd'
      clipRule='evenodd'
