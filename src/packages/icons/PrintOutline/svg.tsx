...
export default ({ width = sizeMap.medium }) => (
  <svg width={width} viewBox='0 0 192 192' fill='none' xmlns='http://www.w3.org/2000/svg'>
    <path
      ...
      fill='#546E7A'
    />
    <path fillRule='evenodd' clipRule='evenodd' d='M134 124H58V148H134V124ZM46 112V160H146V112H46Z' fill='#546E7A' />
    <path fillRule='evenodd' clipRule='evenodd' d='M133 44H58V70H133V44ZM46 32V82H145V32H46Z' fill='#546E7A' />
    <path d='M45 126H48V138H45V126Z' fill='#546E7A' />
    <path
      d='M155 93C155 95.2091 153.209 97 151 97C148.791 97 147 95.2091 147 93C147 90.7909 148.791 89 151 89C153.209 89 155 90.7909 155 93Z'
      fill='#546E7A'
    />
  </svg>
);
